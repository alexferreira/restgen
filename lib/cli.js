...
var ejs = require('ejs');
var usage = 'Usage: restGen new <app_name>\n       restGen model <model_name>\n';
...
function createApp(appName) {
  ...
  pathsToGenerate[appName] = {
    ...
    'package.json': new FileTemplate(path.join(__dirname, 'templates', 'package.json.ejs'),appName),
    'Jakefile.js': new FileTemplate(path.join(__dirname, 'templates', 'Jakefile.js.ejs'),appName),
    'README.md': new FileTemplate(path.join(__dirname, 'templates', 'readme.md.ejs'),appName)
  };
